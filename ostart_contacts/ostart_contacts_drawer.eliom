...
let%shared user_menu () =
  [ item [%i18n S.settings ~capitalize:true] Ostart_contacts_services.settings_service
...
let%shared make ?user () =
  ...
  let items =
    ...
    :: item [%i18n S.about ~capitalize:true] Ostart_contacts_services.about_service
